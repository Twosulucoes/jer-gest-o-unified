                ...
                <CompetitionProvider>
                  <Suspense fallback={<PageLoader />}>
                    <Routes>
                      ...
                      <Route path="/admin/etapa/:stageId" element={<ProtectedRoute allowedRoles={["admin", "secretaria", "coordenacao_tecnica", "transporte", "alimentacao", "alojamento", "coordenador_modalidade"]}><StageLayout /></ProtectedRoute>}>
