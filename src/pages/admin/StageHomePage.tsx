...
const MODULES: ModuleCard[] = [
  ...
  { label: "Vouchers", description: "Listagem e auditoria de vouchers da etapa.", icon: <ClipboardList className="h-5 w-5" />, to: "vouchers", color: "text-emerald-700", roles: ALL_OPS },
];
