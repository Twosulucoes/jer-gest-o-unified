...
export function MatchScoreFormDrawer({ 
  ...
  const schoolA_id = form.watch("school_a_id");
  const filteredSchoolsB = schools.filter(s => s.school_id !== schoolA_id);
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="sm:max-w-xl flex flex-col h-full p-0">
        <SheetHeader className="p-6 pb-2">
          <SheetTitle>{isEditing ? "Confronto e Resultado" : "Novo Confronto"}</SheetTitle>
          <SheetDescription>
            {isEditing ? "Configure os detalhes da partida e registre os resultados." : "Preencha os detalhes do novo confronto."}
          </SheetDescription>
        </SheetHeader>
        ...
        <Tabs defaultValue="detalhes" className="flex-1 flex flex-col min-h-0">
          <div className="px-6 border-b">
            <TabsList className="bg-transparent border-none p-0 h-10">
              <TabsTrigger value="detalhes" className="data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none px-4">Confronto</TabsTrigger>
              {isEditing && <TabsTrigger value="resultado" className="data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none px-4">Resultado</TabsTrigger>}
            </TabsList>
          </div>

          <TabsContent value="detalhes" className="flex-1 flex flex-col min-h-0 mt-0">
            <Form {...form}>
