...
- ✅ Portal público básico funcional via public-results
- ✅ Geração automática e manual de boletins oficiais em PDF (por etapa e final)
- ✅ Quadro de medalhas oficial consolidado (com critérios de desempate)
