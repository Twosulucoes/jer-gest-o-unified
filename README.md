...
>
> **Reformulação Voucher 🚀 Auditoria de Fechamento (2026-04-27)** — Módulo funcional em regras de negócio e UX, com **fila offline integrada**. Identificada pendência de schema no BD para persistência de metadados offline. Detalhes em [`docs/modulos/voucher-auditoria.md`](docs/modulos/voucher-auditoria.md).
