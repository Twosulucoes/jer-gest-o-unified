...
> **Alojamento 🏠 UNIFICADO ✅** — Fase 1 de unificação estrutural concluída. Agora o planejamento (Admin) e a execução (PWA) operam sobre o mesmo esquema `public`, permitindo validação real e registro de divergências. Alocação em lote e scanner de campo 100% integrados (2026-04-28). Detalhes em [`docs/modulos/alojamento-auditoria.md`](docs/modulos/alojamento-auditoria.md).
