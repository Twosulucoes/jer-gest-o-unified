...
> **Módulo de Árbitros 📋 Apuração e Remuneração ✅** — Implementação concluída da Fase 3: configuração de remuneração por etapa/modalidade (diária vs partida) e apuração automática de atividades baseada em atuação comprovada no PWA Ao Vivo. Detalhes em [`docs/modulos/arbitros-auditoria.md`](docs/modulos/arbitros-auditoria.md). (2026-04-28)
