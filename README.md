...
> **Alojamento 🏠 Auditoria de Diagnóstico (2026-04-28)** — Identificada inconsistência estrutural entre o planejamento (Admin) e a execução (PWA) devido a esquemas de dados desconectados. Alocação em lote funcional, mas não integrada ao scanner de campo. Detalhes em [`docs/modulos/alojamento-auditoria.md`](docs/modulos/alojamento-auditoria.md).
