...
>
> **Reformulação Voucher 🚀 Fase 1 Concluída (2026-04-27)** — Implementado o cadastro de pessoas eventuais, evolução do modelo para vínculo com instâncias de serviço, suporte a vouchers anônimos/nominais e desativação dos fluxos legados de voucher para credenciados. Detalhes em [`docs/modulos/voucher.md`](docs/modulos/voucher.md).
