...
>
> **Reformulação Voucher 🚀 Finalizada (2026-04-27)** — Módulo 100% aderente às novas regras: exclusivo para eventuais, amarrado a instâncias de serviço, proteção contra duplo consumo, reemissão com vínculo, **fila offline resiliente em todos os PWAs operacionais** e Central de Auditoria completa. Detalhes em [`docs/modulos/voucher-auditoria.md`](docs/modulos/voucher-auditoria.md).
