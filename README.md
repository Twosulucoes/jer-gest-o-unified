...
> **Alojamento 🏠 GRANULARIDADE, GÊNERO & PRESENÇA ✅** — Fase 2 concluída. Controle rigoroso por **Unidade (Quarto)** no PWA, validação automática de gênero (fonte `people.gender`), bloqueio por capacidade e novo fluxo de **Presença Noturna**. Alertas de divergência proeminentes garantem que a execução siga o planejado (2026-04-28). Detalhes em [`docs/modulos/alojamento-auditoria.md`](docs/modulos/alojamento-auditoria.md).
