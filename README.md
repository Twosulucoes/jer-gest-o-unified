...
>
> **Reformulação Voucher 🚀 Finalizada (2026-04-28)** — Módulo 100% aderente às novas regras: exclusivo para eventuais, amarrado a instâncias de serviço, proteção contra duplo consumo, reemissão com vínculo, fila offline resiliente com **detalhamento de conflitos por motivo e padronização de mensagens online/offline** em todos os PWAs operacionais e Central de Auditoria completa. Detalhes em [`docs/modulos/voucher-auditoria.md`](docs/modulos/voucher-auditoria.md).
