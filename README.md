...
> **Refatoração Competição ✅ Painel Score** — Nova experiência de operação para modalidades de placar (Futsal, Futebol, etc) com grade densa e escalação automática (2026-04-22)
