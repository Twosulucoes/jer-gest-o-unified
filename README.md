...
> **Módulo de Árbitros 📋 Auditoria Diagnóstica (2026-04-28)** — Identificada implementação sólida de designação e escala em lote com detecção de conflitos, mas com lacunas em cadastro técnico, escala preventiva e integração logística. Detalhes em [`docs/modulos/arbitros-auditoria.md`](docs/modulos/arbitros-auditoria.md).
