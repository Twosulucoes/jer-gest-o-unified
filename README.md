...
| **🍽️ Alimentação** | 🟡 | **Auditoria 2026-05-03:** Etapa 0/1 entregues — trava de presença em todos os caminhos do PWA, enum de incidentes estendido e RLS restaurada para `meal_windows`/`meal_locations`. Plano incremental em [`docs/modulos/alimentacao-auditoria.md`](docs/modulos/alimentacao-auditoria.md). |
