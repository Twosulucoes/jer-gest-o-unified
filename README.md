...
> **Alimentação 🍽️ Auditoria de Diagnóstico (2026-04-28)** — Módulo operacional com gestão de janelas, elegibilidade por perfil/delegação e PWA offline funcional. Identificada lacuna em **previsão de demanda automática** para cozinha. Detalhes em [`docs/modulos/alimentacao-auditoria.md`](docs/modulos/alimentacao-auditoria.md).
