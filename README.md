...
>
> **Reformulação Voucher 🚀 Fase 3 Concluída (2026-04-27)** — Implementada validação estrita por instância de serviço e proteção contra duplo consumo. Vouchers agora registram tentativas recusadas para auditoria. Detalhes em [`docs/modulos/voucher.md`](docs/modulos/voucher.md).
