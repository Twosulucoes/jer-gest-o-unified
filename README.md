...
>
> **Reformulação Voucher 🚀 Fase 4 Concluída (2026-04-27)** — Finalizado o ciclo do módulo com fluxos de reemissão (vínculo original-novo), revogação individual/lote e Central de Auditoria unificada para rastreabilidade total. Detalhes em [`docs/modulos/voucher.md`](docs/modulos/voucher.md).
