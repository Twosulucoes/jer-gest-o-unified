...
| :--- | :---: | :--- |
| **🏠 Alojamento** | 🟡 | **Re-audit 2026-05-03:** Etapas 0–1 — re-rotear telas órfãs (Alocação em Lote e Divergências) + cross-check com saída antecipada (bloqueia novo check-in e auto-fecha ocupações ativas via trigger). Plano em [`docs/modulos/alojamento-auditoria.md`](docs/modulos/alojamento-auditoria.md). |
